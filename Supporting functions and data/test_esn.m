...
if nargin == 3 % case where no starting state is specified 
    ...
    stateCollection = ...
        compute_state_matrix(inputSequence, [], esn, nForgetPoints, 'startingState', totalstate) ;
end
